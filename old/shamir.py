...
# The code runs on Python2 and Python3. If you want to run the module code at the bottom in Python2,
# you need to change the print statements to match Python2 style.
...
# For that purposes, I generated some prime numbers of the form pow(2,i) - 1
